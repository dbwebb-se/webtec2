...
console.log(lab.assert(module.max, 6, [[1, 2, 3, 6, 5, 4]]))
...
console.log(lab.assert(module.countWords, 4, ['Mumintrollet bor i skogen.']))
console.log(lab.assert(module.countWords, 4, [' Hej jag heter Mikael ']))

console.log(lab.assert(module.countVowels, 9, ['aeiouyåäö.']))
console.log(lab.assert(module.countVowels, 8, ['Mumintrollet bor i skogen.']))

console.log(lab.assert(module.isPalindrom, true, ['AbccbA']))
